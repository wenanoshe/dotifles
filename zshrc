...
alias v='vim'
alias nv='nvim'
alias bspwmrc='ranger /home/wenanoshe/.config/bspwm'
...
alias mountdrive='$HOME/Desktop/mount-umount/mountdrive.sh'
alias unmountdrive='$HOME/Desktop/mount-umount/unmountdrive.sh'
